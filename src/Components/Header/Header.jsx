            ...
            <div className=" mx-auto w-full container  px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between gap-x-5 w-full py-2 ">
                    ...
                    <div className='relative'>
                        {
                            loading && <span className='absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]'><div className="w-8 h-8 border-4 border-dashed rounded-full opacity-100 border-emerald-600 animate-spin  "></div></span>
                        }
                        {
                            userinfo?.email ? <div className='flex justify-end items-center gap-1'>
                                ...
                                <button onClick={logOutUser} className="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border-2 border-gray-200 font-semibold text-blue-600 hover:bg-blue-50 hover:border-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm  ">log out</button>
                            </div> : <NavLink to={'/login'} className="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border-2 border-gray-200 font-semibold text-blue-600 hover:bg-blue-50 hover:border-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm ">Login</NavLink>
                        }
            ...
            <nav className="relative w-full mx-auto px-4 container sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
                <div className="flex items-center justify-between">
                    <span className='flex justify-start items-center gap-2'>
                        ...
                        <Link className="flex-none text-xl font-bold " aria-label="Brand">FoodWave</Link>
                    </span>
                ...
                <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
                    ...
                    <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
                        <NavLink to={'/'} className="font-medium text-gray-800 hover:text-gray-500 sm:py-6 " >Home</NavLink>
                        <NavLink to={'/foods'} className="font-medium text-gray-800 hover:text-gray-500 sm:py-6 " >Available Foods</NavLink>
                        {
                            userinfo?.email && <>
                                <NavLink to={'/addfood'} className="font-medium text-gray-800 hover:text-gray-500 sm:py-6 ">Add Food</NavLink>
                                <NavLink to={'/manageFood'} className="font-medium text-gray-800 hover:text-gray-500 sm:py-6 ">Manage Foods</NavLink>
                                <NavLink to={'/requestedFood'} className="font-medium text-gray-800 hover:text-gray-500 sm:py-6 "> Requested Food</NavLink></>
                        }
